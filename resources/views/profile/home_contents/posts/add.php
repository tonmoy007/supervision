...
<div class="dissmiss-button">
    ...
    <h4 flex>Add New Post</h4>
        ...
        <form class="super-form" name="addNewForm" ng-submit="submitForm(addNewForm,newPost,'post',newPost.type)">
            ...
            <md-input-container class="md-block" >
                <label>Type</label>
                <md-select ng-model=" newPost.category" required md-on-open="loadCategory('post/category')">
        ...
        <div flex layout="row" layout-align="center end">
          <loader class="form-loader" ng-if="form.addingContent"></loader>
        </div>
    </div>
</div>