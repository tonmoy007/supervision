<div class="page-action" id="actions" ng-controller="actionsCtrl">
   <div class="page-action-container text-right" >
        ...
        <div class="page-action-buttons">
          <md-button ng-click="addNew(this,'School')" class="md-icon-button" aria-label="add new"><md-icon md-svg-src="/img/accessories/add-button-inside-black-circle.svg" ></md-icon> <md-tooltip>
            Add new School
